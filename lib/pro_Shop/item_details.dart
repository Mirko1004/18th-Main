...
import 'package:todo_app_flutter/pro_Shop/you_may_also_like.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[Image.asset('images/shop_cart1.png')],
      ),
          ...
          children: <Widget>[
            Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Image.asset('images/blue_pants.png'),
                    Text(
                      'new season',
                      style: TextStyle(
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: <Widget>[
                        Image.asset('images/blue_circle.png'),
                        Image.asset('images/red_circle.png'),
                        Image.asset('images/white_circle.png'),
                        Image.asset('images/black_circle.png'),
                        Container(
                            height: 29.0,
                            width: 1.0,
                            color: AppColors.greyColor15),
                        Image.asset('images/size_xs.png'),
                        Image.asset('images/size_s.png'),
                        Image.asset('images/size_m.png'),
                        Image.asset('images/size_l.png'),
                      ],
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          Column(
                            children: <Widget>[
                              Image.asset('images/video_play.png'),
                              SizedBox(height: 10.0),
                              Text('VIDEO',
                                  style: AppStyles.getSFUITextRegularStyle(10.0,
                                      -0.01, Colors.black, FontWeight.w400)),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ...
                        Image.asset('images/right_arrow7.png'),
                      ],
                    ),
                    SizedBox(height: 15.0),
                    Container(
